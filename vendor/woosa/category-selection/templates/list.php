...
<?php if( ! empty($items) ):
   ...
   <?php foreach($items as $item):?>
      <li>
         ...
         <?php if('tree' === $level):?>
            <button type="button" class="button button-primary cs-select-item" data-<?php echo PREFIX;?>-cs-load-items="<?php echo $item['id'];?>"><?php _e('Select', 'convesiopay-woocommerce');?></button>
         <?php endif;?>
      </li>
   <?php endforeach;?>
   </ul>
