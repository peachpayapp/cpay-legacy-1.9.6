...
class Service_Checkout extends Service{
   ...
   public function send_payment($payload){
      ...
      return Request::POST([
         ...
         'timeout' => 15,
         'body'    => json_encode($payload)
      ])->send('https://api.convesiopay.com/payment/v1/wc-plugin/payments');
   ...
   public function send_payment_details($payload){
      ...
      return Request::POST([
         ...
         'timeout' => 15,
         'body'    => json_encode($payload)
      ])->send('https://api.convesiopay.com/payment/v1/wc-plugin/payment-details');
   ...
   public function refund_payment($reference, $amount){
      ...
      return Request::POST([
         'headers' => $this->headers(),
         'body'    => json_encode($payload)
      ])->send('https://api.convesiopay.com/payment/v1/wc-plugin/refunds?reference=' . $reference);
   ...
   public function cancel_payment($reference){
      ...
      return Request::POST([
         'headers' => $this->headers(),
         'body'    => json_encode($payload)
      ])->send('https://api.convesiopay.com/payment/v1/wc-plugin/cancels?reference=' . $reference);
   ...
   public function capture_payment($reference, $amount){
      ...
      return Request::POST([
         'headers' => $this->headers(),
         'body'    => json_encode($payload)
      ])->send('https://api.convesiopay.com/payment/v1/wc-plugin/captures?reference=' . $reference);
