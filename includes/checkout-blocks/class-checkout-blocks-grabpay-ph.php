...
class Checkout_Blocks_Grabpay_PH extends AbstractPaymentMethodType {
   ...
   protected $name = 'woosa_adyen_grabpay_ph';
   ...
   public function initialize() {
      ...
      $this->gateway = new Grabpay_PH(false);
   ...
   public function get_payment_method_script_handles() {
      ...
      $script_asset_path = dirname( FILE_NAME ) . '/build/checkout-blocks-grabpay-ph.asset.php';
      ...
      Util::enqueue_scripts([
         [
            'name' => 'checkout-blocks-grabpay-ph',
            'js' => [
      ...
      return [ PREFIX . '-checkout-blocks-grabpay-ph' ];
