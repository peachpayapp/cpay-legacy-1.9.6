...
class Checkout_Blocks_Grabpay_SG extends AbstractPaymentMethodType {
   ...
   protected $name = 'woosa_adyen_grabpay_sg';
   ...
   public function initialize() {
      ...
      $this->gateway = new Grabpay_SG(false);
   ...
   public function get_payment_method_script_handles() {
      ...
      $script_asset_path = dirname( FILE_NAME ) . '/build/checkout-blocks-grabpay-sg.asset.php';
      ...
      Util::enqueue_scripts([
         [
            'name' => 'checkout-blocks-grabpay-sg',
            'js' => [
      ...
      return [ PREFIX . '-checkout-blocks-grabpay-sg' ];
