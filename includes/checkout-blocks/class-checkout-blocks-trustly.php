...
class Checkout_Blocks_Trustly extends AbstractPaymentMethodType {
   ...
   protected $name = 'woosa_adyen_trustly';
   ...
   public function initialize() {
      ...
      $this->gateway = new Trustly(false);
   ...
   public function get_payment_method_script_handles() {
      ...
      $script_asset_path = dirname( FILE_NAME ) . '/build/checkout-blocks-trustly.asset.php';
      ...
      return [ PREFIX . '-checkout-blocks-trustly' ];
