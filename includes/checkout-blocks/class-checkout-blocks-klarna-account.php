...
class Checkout_Blocks_Klarna_Account extends AbstractPaymentMethodType {
   ...
   protected $name = 'woosa_adyen_klarna_account';
   ...
   public function initialize() {
      ...
      $this->gateway = new Klarna_Account(false);
   ...
   public function get_payment_method_script_handles() {
      ...
      $script_asset_path = dirname( FILE_NAME ) . '/build/checkout-blocks-klarna-account.asset.php';
      ...
      Util::enqueue_scripts([
         [
            'name' => 'checkout-blocks-klarna-account',
            'js' => [
      ...
      return [ PREFIX . '-checkout-blocks-klarna-account' ];
