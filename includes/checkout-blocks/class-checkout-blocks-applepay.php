...
class Checkout_Blocks_ApplePay extends AbstractPaymentMethodType {
   ...
   protected $name = 'woosa_adyen_applepay';
   ...
   public function initialize() {
      ...
      $this->gateway = new Applepay(false);
   ...
   public function get_payment_method_script_handles() {
      ...
      $script_asset_path = dirname( FILE_NAME ) . '/build/checkout-blocks-applepay.asset.php';
      ...
      return [ PREFIX . '-checkout-blocks-applepay' ];
