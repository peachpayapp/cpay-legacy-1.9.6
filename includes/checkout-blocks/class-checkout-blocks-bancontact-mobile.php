...
class Checkout_Blocks_Bancontact_Mobile extends AbstractPaymentMethodType {
   ...
   protected $name = 'woosa_adyen_bancontact_mobile';
   ...
   public function initialize() {
      ...
      $this->gateway = new Bancontact_Mobile(false);
   ...
   public function get_payment_method_script_handles() {
      ...
      $script_asset_path = dirname( FILE_NAME ) . '/build/checkout-blocks-bancontact-mobile.asset.php';
      ...
      Util::enqueue_scripts([
         [
            'name' => 'checkout-blocks-bancontact-mobile',
            'js' => [
      ...
      return [ PREFIX . '-checkout-blocks-bancontact-mobile' ];
