...
class Checkout_Blocks_Klarna_PayNow extends AbstractPaymentMethodType {
   ...
   protected $name = 'woosa_adyen_klarna_paynow';
   ...
   public function initialize() {
      ...
      $this->gateway = new Klarna_PayNow(false);
   ...
   public function get_payment_method_script_handles() {
      ...
      $script_asset_path = dirname( FILE_NAME ) . '/build/checkout-blocks-klarna-paynow.asset.php';
      ...
      Util::enqueue_scripts([
         [
            'name' => 'checkout-blocks-klarna-paynow',
            'js' => [
      ...
      return [ PREFIX . '-checkout-blocks-klarna-paynow' ];
