...
class Checkout_Blocks_Wechatpay extends AbstractPaymentMethodType {
   ...
   protected $name = 'woosa_adyen_wechatpay';
   ...
   public function initialize() {
      ...
      $this->gateway = new Wechatpay(false);
   ...
   public function get_payment_method_script_handles() {
      ...
      $script_asset_path = dirname( FILE_NAME ) . '/build/checkout-blocks-wechatpay.asset.php';
      ...
      Util::enqueue_scripts([
         [
            'name' => 'checkout-blocks-wechatpay',
            'js' => [
      ...
      return [ PREFIX . '-checkout-blocks-wechatpay' ];
