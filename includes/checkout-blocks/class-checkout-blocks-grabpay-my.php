...
class Checkout_Blocks_Grabpay_MY extends AbstractPaymentMethodType {
   ...
   protected $name = 'woosa_adyen_grabpay_my';
   ...
   public function initialize() {
      ...
      $this->gateway = new Grabpay_MY(false);
   ...
   public function get_payment_method_script_handles() {
      ...
      $script_asset_path = dirname( FILE_NAME ) . '/build/checkout-blocks-grabpay-my.asset.php';
      ...
      Util::enqueue_scripts([
         [
            'name' => 'checkout-blocks-grabpay-my',
            'js' => [
      ...
      return [ PREFIX . '-checkout-blocks-grabpay-my' ];
