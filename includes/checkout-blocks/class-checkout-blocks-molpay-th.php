...
class Checkout_Blocks_MOLPay_TH extends AbstractPaymentMethodType {
   ...
   protected $name = 'woosa_adyen_molpay_th';
   ...
   public function initialize() {
      ...
      $this->gateway = new MOLPay_TH(false);
   ...
   public function get_payment_method_script_handles() {
      ...
      $script_asset_path = dirname( FILE_NAME ) . '/build/checkout-blocks-molpay-th.asset.php';
      ...
      Util::enqueue_scripts([
         [
            'name' => 'checkout-blocks-molpay-th',
            'js' => [
      ...
      return [ PREFIX . '-checkout-blocks-molpay-th' ];
