...
class Checkout_Blocks_Ideal extends AbstractPaymentMethodType {
   ...
   protected $name = 'woosa_adyen_ideal';
   ...
   public function get_payment_method_script_handles() {
      ...
      $script_asset_path = dirname( FILE_NAME ) . '/build/checkout-blocks-ideal.asset.php';
      ...
      return [ PREFIX . '-checkout-blocks-ideal' ];
