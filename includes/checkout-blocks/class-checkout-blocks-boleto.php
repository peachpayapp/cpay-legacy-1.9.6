...
class Checkout_Blocks_Boleto extends AbstractPaymentMethodType {
   ...
   protected $name = 'woosa_adyen_boleto';
   ...
   public function get_payment_method_script_handles() {
      ...
      $script_asset_path = dirname( FILE_NAME ) . '/build/checkout-blocks-boleto.asset.php';
      ...
      return [ PREFIX . '-checkout-blocks-boleto' ];
