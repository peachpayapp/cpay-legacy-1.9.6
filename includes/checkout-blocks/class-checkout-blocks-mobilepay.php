...
class Checkout_Blocks_Mobilepay extends AbstractPaymentMethodType {
   ...
   protected $name = 'woosa_adyen_mobilepay';
   ...
   public function initialize() {
      ...
      $this->gateway = new Mobilepay(false);
   ...
   public function get_payment_method_script_handles() {
      ...
      $script_asset_path = dirname( FILE_NAME ) . '/build/checkout-blocks-mobilepay.asset.php';
      ...
      Util::enqueue_scripts([
         [
            'name' => 'checkout-blocks-mobilepay',
            'js' => [
      ...
      return [ PREFIX . '-checkout-blocks-mobilepay' ];
