...
class Checkout_Blocks_Paypal extends AbstractPaymentMethodType {
   ...
   protected $name = 'woosa_adyen_paypal';
   ...
   public function get_payment_method_script_handles() {
      ...
      $script_asset_path = dirname( FILE_NAME ) . '/build/checkout-blocks-paypal.asset.php';
      ...
      return [ PREFIX . '-checkout-blocks-paypal' ];
