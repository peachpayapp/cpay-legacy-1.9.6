...
class Checkout_Blocks_Alipay extends AbstractPaymentMethodType {
   ...
   protected $name = 'woosa_adyen_alipay';
   ...
   public function get_payment_method_script_handles() {
      ...
      $script_asset_path = dirname( FILE_NAME ) . '/build/checkout-blocks-alipay.asset.php';
      ...
      return [ PREFIX . '-checkout-blocks-alipay' ];
