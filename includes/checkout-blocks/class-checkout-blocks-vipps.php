...
class Checkout_Blocks_Vipps extends AbstractPaymentMethodType {
   ...
   protected $name = 'woosa_adyen_vipps';
   ...
   public function get_payment_method_script_handles() {
      ...
      $script_asset_path = dirname( FILE_NAME ) . '/build/checkout-blocks-vipps.asset.php';
      ...
      return [ PREFIX . '-checkout-blocks-vipps' ];
