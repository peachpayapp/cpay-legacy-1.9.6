...
class Checkout_Blocks_Online_Banking_Poland extends AbstractPaymentMethodType {
   ...
   protected $name = 'woosa_adyen_online_banking_poland';
   ...
   public function initialize() {
      ...
      $this->gateway = new Online_Banking_Poland(false);
   ...
   public function get_payment_method_script_handles() {
      ...
      $script_asset_path = dirname( FILE_NAME ) . '/build/checkout-blocks-online-banking-poland.asset.php';
      ...
      Util::enqueue_scripts([
         [
            'name' => 'checkout-blocks-online-banking-poland',
            'js' => [
      ...
      return [ PREFIX . '-checkout-blocks-online-banking-poland' ];
