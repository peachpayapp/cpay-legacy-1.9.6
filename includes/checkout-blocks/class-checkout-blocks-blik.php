...
class Checkout_Blocks_Blik extends AbstractPaymentMethodType {
   ...
   protected $name = 'woosa_adyen_blik';
   ...
   public function get_payment_method_script_handles() {
      ...
      $script_asset_path = dirname( FILE_NAME ) . '/build/checkout-blocks-blik.asset.php';
      ...
      return [ PREFIX . '-checkout-blocks-blik' ];
