...
class Checkout_Blocks_Sofort extends AbstractPaymentMethodType {
   ...
   protected $name = 'woosa_adyen_sofort';
   ...
   public function get_payment_method_script_handles() {
      ...
      $script_asset_path = dirname( FILE_NAME ) . '/build/checkout-blocks-sofort.asset.php';
      ...
      return [ PREFIX . '-checkout-blocks-sofort' ];
