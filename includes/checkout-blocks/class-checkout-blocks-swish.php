...
class Checkout_Blocks_Swish extends AbstractPaymentMethodType {
   ...
   protected $name = 'woosa_adyen_swish';
   ...
   public function get_payment_method_script_handles() {
      ...
      $script_asset_path = dirname( FILE_NAME ) . '/build/checkout-blocks-swish.asset.php';
      ...
      return [ PREFIX . '-checkout-blocks-swish' ];
