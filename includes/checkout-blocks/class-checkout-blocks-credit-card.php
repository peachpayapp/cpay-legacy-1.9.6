...
class Checkout_Blocks_Credit_Card extends AbstractPaymentMethodType {
   ...
   protected $name = 'woosa_adyen_credit_card';
   ...
   public function initialize() {
      ...
      $this->gateway = new Credit_Card(false);
   ...
   public function get_payment_method_script_handles() {
      ...
      $script_asset_path = dirname( FILE_NAME ) . '/build/checkout-blocks-credit-card.asset.php';
      ...
      Util::enqueue_scripts([
         [
            'name' => 'checkout-blocks-credit-card',
            'js' => [
      ...
      return [ PREFIX . '-checkout-blocks-credit-card' ];
