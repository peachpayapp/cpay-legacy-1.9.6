...
class Country_Selection {
   ...
   public function get_list_template($items){
      ...
      return Util::get_template('list.php', [
         'items' => $items,
         'level' => $this->level,
   ...
   public function get_trail_template($item_id){
      ...
      return Util::get_template('trail.php', [
         'items' => $results,
      ], \dirname(__FILE__), '/templates');
   ...
   public static function render($source, $level){
      ...
      ], \dirname(__FILE__), '/templates/select');
