...
class Swish extends Abstract_Gateway{
   ...
   public function get_default_title(){
      return __('ConvesioPay - Swish', 'convesiopay-woocommerce');
   }
   ...
   public function get_default_description(){
      return sprintf(__('Shoppers can pay with Swish when shopping online or in-store using our terminals. %s', 'convesiopay-woocommerce'), '<br/>'.$this->show_supported_country());
   }
