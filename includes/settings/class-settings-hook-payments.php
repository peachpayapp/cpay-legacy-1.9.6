...
class Settings_Hook_Payments implements Interface_Hook_Settings_Tab{
   ...
   public static function name(){
      return __('Payments', 'convesiopay-woocommerce');
   }
   ...
   public static function description(){
      return __('Configure payments', 'convesiopay-woocommerce');
   }
